...
runDay inputParser partA partB verbosity inputFile = do
    ...
    case input of
        ...
        Right i -> do
            ...
            let
                timeA = realToFrac $ diffUTCTime time2 time1
            when (verbosity >= Timings && successA) $ putStrLn $ printf "(%.5f s)" timeA
            ...
            let
                timeB = realToFrac $ diffUTCTime time3 time2
            when (verbosity >= Timings && successB) $ putStrLn $ printf "(%.5f s)" timeB

...
main = hspec $ do
    describe "AoC" $ do
        ...
        it "202203" $ do runDay ("2022", "03")
        it "202204" $ do runDay ("2022", "04")
        it "202205" $ do runDay ("2022", "05")
        it "202206" $ do runDay ("2022", "06")
        it "202207" $ do runDay ("2022", "07")
        it "202208" $ do runDay ("2022", "08")
        it "202209" $ do runDay ("2022", "09")
        it "202210" $ do runDay ("2022", "10")
        it "202211" $ do runDay ("2022", "11")
        it "202212" $ do runDay ("2022", "12")
        it "202213" $ do runDay ("2022", "13")
        it "202214" $ do runDay ("2022", "14")
        it "202215" $ do runDay ("2022", "15")
        it "202216" $ do runDay ("2022", "16")
